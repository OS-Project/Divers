...
jQuery(function(a){var b=["Di","Lu","Ma","Me","Je","Ve","Sa"],c=["Dim","Lun","Mar","Mer","Jeu","Ven","Sam"],
d=["Dimanche","Lundi","Mardi","Mercredi","Jeudi","Vendredi","Samedi"],e=["Janvier","F\u00e9vrier","Mars","Avril","Mai","Juin","Juillet","Ao\u00fbt","Septembre","Octobre","Novembre",
"D\u00e9cembre"],f=["Jan","F\u00e9v","Mar","Avr","Mai","Jun","Jul","Ao\u00fb","Sep","Oct","Nov","D\u00e9c"];a.datepicker.regional[""]={closeText:"Termin\u00e9",prevText:"Pr\u00e9c.",
nextText:"Suivant",currentText:"Aujourd\'hui",monthNames:e,monthNamesShort:f,dayNames:d,dayNamesShort:c,dayNamesMin:b,weekHeader:"sem",dateFormat:a.datepicker.ISO_8601,firstDay:1,isRTL:!1,showMonthAfterYear:!1,yearSuffix:""};a.datepicker.setDefaults(a.datepicker.regional[""])});
} catch (err) {
    if (console && console.log && console.error) {
        console.log("Error running batched script.");
        console.error(err);
...
d);f.sessionFail(a,b)})}},sessionFail:function(a,b){if(!a){var d=c(".aui-dialog:visible");if(d.length)a=d.find(".dialog-panel-body").empty(),d.find(".aui-button").attr("disabled","disabled");else throw Error("sessionFail method really expected a visible dialog about now :/");}b||(b=AJS.format("Votre session a expir\u00e9. Veuillez {0}recharger{1} la page pour r\u00e9essayer.",'<a class="reload" href="">',"</a>"),a.on("click","a.reload",function(){window.location.reload()}));AJS.messages.warning(a,{body:b,closeable:!1,shadowed:!0})},Binder:{placeFocus:function(){var a,
...
Confluence.Templates.Dialog.helpLink = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  Confluence.Templates.Dialog.customHelpLink({href: opt_data.href, text: soy.$$escapeHtml("Aide")}, output);
  return opt_sb ? '' : output.toString();
};
...
AJS.toInit(function(a){if(a("link[rel=canonical]").length){var c=null;a("#link-to-page-link").click(function(d){if(!c){c=(new AJS.Dialog(600,210,"link-page-popup")).addHeader("Lien vers cette page").addPanel("Lien vers cette page","<form id='link-page-popup-form' class='aui'><fieldset></fieldset></form>").addCancel("Fermer",function(){c.hide();return!1});Confluence.KeyboardShortcuts&&Confluence.KeyboardShortcuts.enabled&&
c.addHelpText(AJS.format("Astuce (raccourci)\u00a0: vous pouvez \u00e9galement ouvrir cette bo\u00eete de dialogue en appuyant sur \u003cb\u003e{0}\u003c/b\u003e","k"));var b=[{label:"Lien",id:"link",value:a("link[rel=canonical]").attr("href")},{label:"Lien court",id:"tiny-link",value:a("link[rel=shortlink]").attr("href")}];a.each(b,function(){a("#link-page-popup-form fieldset").append(AJS.format("<div class='field-group'><label for=''link-popup-field-{0}''>{1}:</label><input id=''link-popup-field-{0}'' readonly=''readonly'' value='''' class=''text'' type=''text''></div>",
...
AJS.Labels.openDialog(a):AJS.Labels.openDialog()})};AJS.Labels.openDialog=function(a){var f,d,e;c||(c=AJS.ConfluenceDialog({width:600,height:250,id:"edit-labels-dialog",onCancel:h}),c.addHeader("Etiquettes"),c.addPanel("Label Editor",Confluence.Templates.Labels.dialog()),c.addCancel("Fermer",h),c.addHelpText("Shortcut tip: In page view, pressing \u003cb\u003e{shortcut}\u003c/b\u003e also opens this dialog box",{shortcut:"l"}),c.popup.element.find(".dialog-title").prepend(Confluence.Templates.Labels.helpLink()),b("#add-labels-form").submit(function(a){var c=
...
Confluence.Templates.Labels.labels = function(opt_data, opt_sb) {
  ...
  for (var labelIndex14 = 0; labelIndex14 < labelListLen14; labelIndex14++) {
    ...
    output.append('<li class="aui-label ', (opt_data.editable) ? 'aui-label-closeable aui-label-split' : '', '" data-label-id="', soy.$$escapeHtml(labelData14.id), '"><a class="aui-label-split-main" href="', soy.$$escapeHtml(""), '/label/', soy.$$escapeHtml(opt_data.spaceKey), '/', soy.$$escapeHtml(labelData14.name), '" rel="tag">', (! labelData14.prefix || labelData14.prefix == 'global' || labelData14.prefix == 'team') ? soy.$$escapeHtml(labelData14.name) : soy.$$escapeHtml(labelData14.prefix) + ':' + soy.$$escapeHtml(labelData14.name), '</a>', (opt_data.editable) ? '<span class="aui-label-split-close"><span tabindex="0" class="aui-icon aui-icon-close"  title="' + soy.$$escapeHtml("Supprimer l\x27\xe9tiquette") + '" original-title="' + soy.$$escapeHtml("Supprimer l\x27\xe9tiquette") + '">' + soy.$$escapeHtml("Supprimer l\x27\xe9tiquette") + '</span></span>' : '', '</li>');
  }
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.Labels.nolabels = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<li class="no-labels-message">', soy.$$escapeHtml("Aucune \xe9tiquette"), '</li>');
  return opt_sb ? '' : output.toString();
};
...
a.fail(function(a,b){var c;if("timeout"===b)c="La connexion au serveur a \u00e9chou\u00e9, il vous faut r\u00e9esayer";else try{c=JSON.parse(a.responseText).message}catch(d){c=b,AJS.log("Unexpected error when adding labels: "+d.message)}AJS.log("Failed to add labels: "+c);AJS.log("Failed to add labels xhr: "+a.responseText);n(c);f.reject(b)});a=f.promise()}else a=!1;return t(a)},removeLabel:function(a,g,d){var c=a,h=g,e=d;if(c){c=c.jquery?c:b(c);q()&&(h=AJS.Meta.get("space-key"),e="space");var f=c.attr(i.idAttribute),j=b.trim(c.find("a").text()),
a={type:"DELETE",dataType:"json",contentType:"application/json",data:{}},o=b.Deferred();k()?(a=b.Deferred(),a.resolve()):(a.url=m.remove(e,h,f),a=AJS.$.ajax(a));a.done(function(){var a=p(h,e);q()&&(a=b("#space-categories-list"));var d=a.find(i.labelItem).filter("["+i.idAttribute+"='"+f+"']");d.fadeOut("normal",function(){d.remove();o.resolve(c,a)})});a.fail(function(a,b){AJS.log(b);n(b=="timeout"?"La connexion au serveur a \u00e9chou\u00e9, il vous faut r\u00e9esayer":b);o.reject(b)});k()&&o.done(function(){var a=b("#"+i.labelsFormFieldId),
...
jQuery(function(e){e(document).on("click","#manage-watchers-menu-item, .cw-manage-watchers",function(m){m.preventDefault();var c=new AJS.ConfluenceDialog({width:865,height:530,id:"manage-watchers-dialog",onCancel:function(){c.hide().remove()}});c.addHeader("G\u00e9rer les observateurs");c.addPanel("default",Confluence.Templates.ManageWatchers.dialogContent({pageId:AJS.Meta.get("page-id"),xsrfToken:AJS.Meta.get("atl-token")}));c.addCancel("Fermer",function(){c.hide().remove();
...
username:c},error:function(){console.error("La suppression de l\'observateur a \u00e9chou\u00e9. Actualisez la page pour voir l\'\u00e9tat le plus r\u00e9cent.");d.removeClass("removing")},success:function(){d.slideUp().remove();b.trigger("list-updated.manage-watchers",{list:e})}})});b.bind("list-updated.manage-watchers",function(a,b){var d=b.list;0<e("li.watch-user",d).length?(d.find(".no-users").addClass("hidden"),Confluence.Binder.userHover(),d.find(".confluence-userlink").each(function(){e(this).click(function(a){a.preventDefault()})})):d.find(".no-users").removeClass("hidden")});
...
Confluence.Templates.ManageWatchers.dialogContent = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<div class="aui-group"><div class="aui-item page-watchers"><h3>', soy.$$escapeHtml("Observateurs de la page"), '</h3><p>', soy.$$escapeHtml("Ces utilisateurs sont notifi\xe9s de toute modification apport\xe9e \xe0 la page. Vous pouvez ajouter ou supprimer des utilisateurs de la liste."), '</p><form class="aui" action="', soy.$$escapeHtml(""), '/json/addwatch.action" method="POST"><input type="hidden" name="atl_token" value="', soy.$$escapeHtml(opt_data.xsrfToken), '"><input type="hidden" name="pageId" value="', soy.$$escapeHtml(opt_data.pageId), '"/><input type="hidden" id="add-watcher-username" name="username" value=""/><label for="add-watcher-user">', soy.$$escapeHtml("Utilisateur"), '</label><input id="add-watcher-user" name="userFullName" class="text autocomplete-user" type="text" value="" placeholder="', soy.$$escapeHtml("Nom ou adresse \xe9lectronique de l\x27utilisateur"), '" data-max="10" data-target="#add-watcher-username" data-dropdown-target="#add-watcher-dropdown" data-template="{title}" data-none-message="', soy.$$escapeHtml("La recherche ne renvoie aucun r\xe9sultat"), '"><input id="add-watcher-submit" type="submit" name="add"  class="button submit" value="', soy.$$escapeHtml("Ajouter"), '"><div id="add-watcher-dropdown" class="aui-dd-parent autocomplete"></div><div class="status hidden"></div></form><ul class="user-list"><li class="loading">', "Chargement en cours\u2026", '</li><li class="no-users hidden">', soy.$$escapeHtml("Aucun observateur de page"), '</li></ul></div><div class="aui-item space-watchers"><h3>', soy.$$escapeHtml("Observateurs de l\x27espace"), '</h3><p>', soy.$$escapeHtml("Ces utilisateurs sont notifi\xe9s de toute modification apport\xe9e au contenu de l\x27espace. Vous ne pouvez pas modifier cette liste."), '</p><ul class="user-list"><li class="loading">', "Chargement en cours\u2026", '</li><li class="no-users hidden">', soy.$$escapeHtml("Aucun observateur d\x27espace"), '</li></ul></div></div>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.ManageWatchers.userItem = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<li class="watch-user"><img class="profile-picture confluence-userlink" src="', soy.$$escapeHtml(opt_data.iconUrl), '" data-username="', soy.$$escapeHtml(opt_data.username), '"><span class="user-hover-trigger" data-username="', soy.$$escapeHtml(opt_data.username), '">', soy.$$escapeHtml(opt_data.fullName), '</span> <span class="username">(', soy.$$escapeHtml(opt_data.username), ')</span><span class="remove-watch" title="', soy.$$escapeHtml("Supprimer"), '" data-username="', soy.$$escapeHtml(opt_data.username), '">', soy.$$escapeHtml("Supprimer"), '</span></li>');
  return opt_sb ? '' : output.toString();
};
...
"/json/pagechildren.action",type:"POST",data:{pageId:AJS.params.pageId,showChildren:!0},success:j,error:function(a,b){var c="Impossible de charger les pages enfant.";h();d.html("<span class='error'>"+c+"</span>");AJS.log("Error retrieving child pages: "+b)}})):g(!0)}else g(!0);b.removeClass("children-hidden").addClass("children-showing")}return AJS.stopEvent(a)})})});
} catch (err) {
    if (console && console.log && console.error) {
        console.log("Error running batched script.");
        console.error(err);
...
Confluence.Templates.Blueprints.waitContainer = function(opt_data, opt_sb) {
  ...
  output.append('<span class="wait-text">', soy.$$escapeHtml("Chargement"), '&hellip;</span></div>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.Blueprints.sidebarIndexPagePopup = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<h2>', soy.$$escapeHtml(AJS.format("Trouver vos {0} ici",opt_data.indexPageTitle)), '</h2><p>', soy.$$escapeHtml(AJS.format("Vous avez cr\xe9\xe9 une page {0}. Un raccourci a \xe9t\xe9 ajout\xe9 dans le volet lat\xe9ral, vous pourrez y trouver les autres {0} de cet espace.",opt_data.indexPageTitle)), '</p><br/><form><button id="dismiss-index-popup" class="aui-button aui-style" type="submit">', soy.$$escapeHtml("Ignorer"), '</button></form>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.Blueprints.howToUseSkipCheckbox = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<div class="dialog-tip"><input id="dont-show-how-to-use" type="checkbox" name="skipHowToUse"><label for="dont-show-how-to-use" type="checkbox"><span class="checkbox-label">', soy.$$escapeHtml("Ne plus afficher ce message"), '</span></label></div>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.Blueprints.createDialogLocationPanel = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<div class="create-dialog-location-bar"><div><label>', soy.$$escapeHtml("S\xe9lectionnez un espace"), '</label><div class="space-select-control-container"><input type="text" class="space-select" tabindex="100"/><div class="description hidden">', soy.$$escapeHtml("Seuls vos espaces sugg\xe9r\xe9s sont pr\xe9sent\xe9s ici."), '&nbsp;<a href="" title="', soy.$$escapeHtml("Si l\x27espace de votre choix n\x27est pas dans cette liste, ouvrez une page de l\x27espace et r\xe9essayez (Le site a trop d\x27espaces pour les montrer tous ici)."), '" tabindex="-1">', soy.$$escapeHtml("Pourquoi?"), '</a></div></div></div><div id="create-dialog-parent-container">', soy.$$escapeHtml("Parent"), ':&nbsp;<span></span></div></div>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.Blueprints.Promoted.showMore = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<li class="promoted-link-container"><div><button id="promoted-link" class="aui-button aui-button-link">', soy.$$escapeHtml("Afficher plus"), '</button></div></li>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.Blueprints.Promoted.promoteTemplateLink = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<button class=\'promoted-template-link aui-button-link aui-button\' data-promoted=\'', soy.$$escapeHtml(opt_data.templatePromoted), '\' title=\'', soy.$$escapeHtml("Les mod\xe8les promus s\x27affichent en haut de la bo\xeete de dialogue Cr\xe9er. Les mod\xe8les et les Blueprints non promus s\x27affichent dessous, de mani\xe8re r\xe9duite."), '\'>', (opt_data.templatePromoted) ? soy.$$escapeHtml("Annuler la promotion") : soy.$$escapeHtml("Promouvoir"), '</button>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.Blueprints.CreateSpace.createSpaceFormFields = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<fieldset><div class="field-group"><label for="name">', soy.$$escapeHtml("Nom d\x27espace"), (! opt_data.disableRequiredIcon) ? '<span class="aui-icon icon-required"/>' : '', '</label><input class="text long-field" name="name" autocomplete="off" ', (opt_data.name) ? 'value="' + soy.$$escapeHtml(opt_data.name) + '"' : '', '/>');
  ...
  output.append('</div><div class="field-group"><label for="spaceKey">', soy.$$escapeHtml("Cl\xe9 d\x27espace"), (! opt_data.disableRequiredIcon) ? '<span class="aui-icon icon-required"/>' : '', '</label><input class="text long-field" name="spaceKey" ', (opt_data.spaceKey) ? 'value="' + soy.$$escapeHtml(opt_data.spaceKey) + '"' : '', '/><span class="aui-icon aui-icon-small aui-iconfont-help" data-unicode="UTF+E003" data-tooltip="', soy.$$escapeHtml("Cette cl\xe9 unique est utilis\xe9e dans l\x27URL de votre espace"), '" original-title=""/>');
...
Confluence.Templates.Blueprints.CreateSpace.createPersonalSpaceForm = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<form method="post" class="aui common-space-form how-to-use-blueprint-page"><h2>', soy.$$escapeHtml("Un espace personnel vous permet d\x27effectuer les t\xe2ches suivantes\xa0:"), '</h2><ol class="howto-steps horizontal"><li class="howto-step"><h3>', soy.$$escapeHtml("Soyez organis\xe9"), '</h3><p>', soy.$$escapeHtml("Organisez vos notes, vos listes de t\xe2ches, vos fichiers et tout autre contenu personnel."), '</p></li><li class="howto-step"><h3>', soy.$$escapeHtml("Partagez des nouvelles"), '</h3><p>', soy.$$escapeHtml("Utilisez votre blog pour faire des annonces, pr\xe9senter des id\xe9es et partager vos connaissances."), '</p></li><li class="howto-step"><h3>', soy.$$escapeHtml("Pr\xe9sentez-vous"), '</h3><p>', soy.$$escapeHtml("Personnalisez votre page d\x27accueil personnelle, dans laquelle vous vous pr\xe9sentez \xe0 l\x27\xe9quipe."), '</p></li></ol></form>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.Blueprints.CreateSpace.spaceFormPermissions = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<fieldset class="group', (opt_data.spacePermission == 'private') ? ' locked' : '', '" id="permissions-group"><div class="checkbox"><input class="checkbox" type="checkbox" id="permission-private" name="spacePermission" value="private"', (opt_data.spacePermission == 'private') ? ' checked="checked"' : '', ' /><label for="permission-private">', soy.$$escapeHtml("Visible uniquement par moi"), '</label></div></fieldset>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.Blueprints.CreateSpace.welcome = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<ul class="space-types"><li><p>', soy.$$escapeHtml("\xc9quipe"), '</p></li><li><p>', soy.$$escapeHtml("Projet"), '</p></li><li><p>', soy.$$escapeHtml("Service"), '</p></li></ul><div class="space-description"><h1>', soy.$$escapeHtml("Un espace h\xe9berge tout votre contenu"), '</h1><ul><li>', soy.$$escapeHtml("Cr\xe9ez autant d\x27espaces que vous voulez pour les \xe9quipes, les projets et les services de votre entreprise."), '</p></li><li>', soy.$$escapeHtml("Ajoutez des documents, des fichiers et des photos \xe0 votre espace en utilisant des pages et organisez-les en utilisant une hi\xe9rarchie."), '</p></li><li>', soy.$$escapeHtml("Utilisez le blog de votre espace pour partager des informations et faire vos annonces."), '</p></li></ul></div>');
  return opt_sb ? '' : output.toString();
};
...
(function(d){var c;Confluence.KeyboardShortcuts.getDialog=function(){function m(){Confluence&&Confluence.Editor&&Confluence.Editor.isVisible&&Confluence.Editor.isVisible()?(c.overrideLastTab(),c.gotoPanel(1)):c.gotoPanel(0)}var k=d.Deferred();if(c)return m(),k.resolve(c);var e=Confluence.KeyboardShortcuts.shortcuts,n=-1!=navigator.platform.indexOf("Mac"),p=function(b){for(var a=AJS("span").addClass("item-action"),b=b.keys[0],c=0;c<b.length;c++){0<c&&a.append(l("alors"));
for(var d=a,g=b[c].split("+"),f=0;f<g.length;f++){0<f&&d.append(l("+"));for(var h=d,i=g[f].split(".."),e=0;e<i.length;e++)0<e&&h.append(l("\u00e0")),h.append(o(i[e]))}}return a},o=function(b){var a=AJS("kbd");switch(b){case "Shift":case "Sh":a.text("Shift");a.addClass("modifier-key");break;case "Ctrl":b=n?"⌘":"Ctrl";a.text(b);a.addClass("modifier-key");break;case "Tab":a.text("Tab");
...
f.description,i=AJS("strong").addClass("item-description").append(i);h.append(i);h.append(p(f));e.append(h)}}return b};c=AJS.ConfluenceDialog({width:950,height:660,id:"keyboard-shortcuts-dialog"});c.addHeader("Raccourcis de clavier");c.addPanel("G\u00e9n\u00e9ral",function(){var b=d(Confluence.Templates.KeyboardShortcutsDialog.keyboardShortcutPanel({panelId:"general-shortcuts-panel"})),a=d(b).children(".shortcutsmenu");AJS.Meta.get("remote-user")&&
b.find(".keyboard-shortcut-dialog-panel-header").append(Confluence.Templates.KeyboardShortcutsDialog.keyboardShortcutEnabledCheckbox());a.append(j("Raccourcis globaux",["global"],e));a.append(j("Actions Page / Billet de blog",["viewcontent","viewinfo"],e));return b}());c.addPanel("Editeur",function(){var b=d(Confluence.Templates.KeyboardShortcutsDialog.keyboardShortcutPanel({panelId:"editor-shortcuts-panel"})),
a=d(b).children(".shortcutsmenu");a.append(j("Mise en forme de bloc",["tinymce.block"],e));a.append(j("Mise en forme enrichie",["tinymce.rich"],e));a.append(j("Actions de modification",["tinymce.actions"],e));return b}());c.addCancel("Fermer",function(){AJS.debug("Hiding Shortcuts help");c.hide();return!1});c.popup.element.find(".dialog-title").prepend(Confluence.Templates.KeyboardShortcutsDialog.keyboardShortcutHelpLink());
...
return d(c,b,function(b){return a.emoticonHelpItem({src:e+b.img,type:b.action})})},j=function(){var d=e(Confluence.Templates.KeyboardShortcutsDialog.keyboardShortcutPanel({panelId:"autoformat-shortcuts-panel"})),b=d.children(".shortcutsmenu");b.append(c("Mise en forme des polices","autoformat.font_formatting",a.simpleHelpItem));b.append(c("Saisie semi-automatique","autoformat.autocomplete",a.keyboardShortcutItem));
b.append(c("Tableaux","autoformat.tables",a.tableHelpItem));b.append(c("Styles","autoformat.styles",a.styleHelpItem).addClass("styles-module"));b.append(i("Emotic\u00f4nes","autoformat.emoticons"));b.append(c("Listes","autoformat.lists",a.simpleHelpItem));AJS.Meta.get("remote-user")&&d.find(".keyboard-shortcut-dialog-panel-header").append(a.configureAutocomplete({href:Confluence.getContextPath()+
"/users/viewmyeditorsettings.action"}));return d};AJS.bind("keyboard-shortcut-dialog-ready",function(a,b){b.addPanel("Mise en forme automatique de l\'\u00e9diteur",j())});Confluence.KeyboardShortcuts.Autoformat=[{context:"autoformat.font_formatting",description:a.boldDescription(),action:"*Gras*"},{context:"autoformat.font_formatting",description:a.underlineDescription(),action:"+Soulign\u00e9+"},
{context:"autoformat.font_formatting",description:a.italicDescription(),action:"_Italique_"},{context:"autoformat.font_formatting",description:a.monospaceDescription(),action:"{{Espacement fixe}}"},{context:"autoformat.tables",description:a.tableDescription(),action:"||||| + entrer"},{context:"autoformat.tables",description:a.tableWithHeadingsDiscriptions(),
action:"||en-t\u00eate||en-t\u00eate||"},{context:"autoformat.styles",description:a.h1Description(),action:"h1. En-t\u00eate"},{context:"autoformat.styles",description:a.h3Description(),action:"h3. En-t\u00eate"},{context:"autoformat.styles",description:a.bqDescription(),action:"bq. Guillemets"},{context:"autoformat.emoticons",
img:"check.png",action:"(/)"},{context:"autoformat.emoticons",img:"smile.png",action:":)"},{context:"autoformat.lists",description:a.numberedListDescription(),action:"# liste"},{context:"autoformat.lists",description:a.bulletedListDescription(),
action:"* puces"},{context:"autoformat.lists",description:a.inlineTaskListDescription(),action:"[] t\u00e2che"},{context:"autoformat.autocomplete",description:"Image/M\u00e9dia",action:"!"},{context:"autoformat.autocomplete",description:"Lien",action:"["},
...
Confluence.Templates.KeyboardShortcutsDialog.Autoformat.configureAutocomplete = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<div id="keyboard-shortcut-autocomplete-message">', soy.$$escapeHtml("Pour configurer la fonction de saisie semi-automatique,"), ' <a target="_blank" href=', soy.$$escapeHtml(opt_data.href), '>', soy.$$escapeHtml("allez aux param\xe8tres de votre \xe9diteur"), '</a></div>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.KeyboardShortcutsDialog.Autoformat.boldDescription = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<b>', soy.$$escapeHtml("Gras"), '</b> ', soy.$$escapeHtml("texte"));
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.KeyboardShortcutsDialog.Autoformat.underlineDescription = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<span style="text-decoration: underline;">', soy.$$escapeHtml("Soulign\xe9"), '</span> ', soy.$$escapeHtml("texte"));
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.KeyboardShortcutsDialog.Autoformat.italicDescription = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<em>', soy.$$escapeHtml("Italique"), '</em> ', soy.$$escapeHtml("texte"));
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.KeyboardShortcutsDialog.Autoformat.monospaceDescription = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<code>', soy.$$escapeHtml("Espacement fixe"), '</code> ', soy.$$escapeHtml("texte"));
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.KeyboardShortcutsDialog.Autoformat.tableDescription = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<table class="confluenceTable"><tbody><tr><td class="confluenceTd">', soy.$$escapeHtml("premi\xe8re cellule"), '</td><td class="confluenceTd">&nbsp;</td><td class="confluenceTd">&nbsp;</td><td class="confluenceTd">&nbsp;</td></tr></tbody></table>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.KeyboardShortcutsDialog.Autoformat.tableWithHeadingsDiscriptions = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<table class="confluenceTable"><tbody><tr><th class="confluenceTh">', soy.$$escapeHtml("en-t\xeate"), '</th><th class="confluenceTh">', soy.$$escapeHtml("en-t\xeate"), '</th></tr><tr><td class="confluenceTd">&#8203;</td><td class="confluenceTd">&#8203;</td></tr></tbody></table>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.KeyboardShortcutsDialog.Autoformat.h1Description = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<h1>', soy.$$escapeHtml("En-t\xeate"), '</h1>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.KeyboardShortcutsDialog.Autoformat.h3Description = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<h3>', soy.$$escapeHtml("En-t\xeate"), '</h3>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.KeyboardShortcutsDialog.Autoformat.bqDescription = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<blockquote>', soy.$$escapeHtml("Guillemets"), '</blockquote>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.KeyboardShortcutsDialog.Autoformat.bulletedListDescription = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<ul><li>', soy.$$escapeHtml("puces"), '</li></ul>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.KeyboardShortcutsDialog.keyboardShortcutHelpLink = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  Confluence.Templates.Dialog.customHelpLink({href: soy.$$escapeHtml("https://docs.atlassian.com/confluence/docs-57/Keyboard+Shortcuts"), text: soy.$$escapeHtml("Afficher tous les raccourcis")}, output);
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.KeyboardShortcutsDialog.keyboardShortcutEnabledCheckbox = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<form name="shortcut-settings" id="shortcut-settings-form"><input type="checkbox" name="enabled" id="keyboard-shortcut-enabled-checkbox"><label for="keyboard-shortcut-enabled-checkbox">', soy.$$escapeHtml("Activer les principaux raccourcis"), '</label></form>');
  return opt_sb ? '' : output.toString();
};
...
aui.labels.closeIconText = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append((opt_data.closeIconText) ? soy.$$escapeHtml(opt_data.closeIconText) : '(' + soy.$$escapeHtml("Retirer") + ' ' + soy.$$escapeHtml(opt_data.text) + ')');
  return opt_sb ? '' : output.toString();
};
...
aui.sidebar.sidebar = function(opt_data, opt_sb) {
  ...
  aui.renderExtraAttributes(opt_data, output);
  output.append('><div class="aui-sidebar-wrapper"><div class="aui-sidebar-body">', opt_data.headerContent, opt_data.content, '</div><div class="aui-sidebar-footer">', (opt_data.footerContent) ? opt_data.footerContent : (opt_data.settingsButtonUrl && opt_data.settingsText) ? '<a href="' + soy.$$escapeHtml(opt_data.settingsButtonUrl) + '" class="aui-button aui-button-subtle aui-sidebar-settings-button' + ((opt_data.isSettingsButtonSelected) ? ' aui-sidebar-settings-selected' : '') + '" data-tooltip="' + soy.$$escapeHtml(opt_data.settingsTooltip ? opt_data.settingsTooltip : opt_data.settingsText) + '"><span class="aui-icon aui-icon-small aui-iconfont-configure"></span><span class="aui-button-label">' + soy.$$escapeHtml(opt_data.settingsText) + '</span></a>' : '', '<a class="aui-button aui-button-subtle aui-sidebar-toggle aui-sidebar-footer-tipsy" data-tooltip="', soy.$$escapeHtml("D\xe9velopper la barre lat\xe9rale ( [ )"), '" href="#"><span class="aui-icon aui-icon-small"></span></a></div>', (opt_data.isResizable) ? '<div class="aui-sidebar-handle"></div>' : '', '</div></', soy.$$escapeHtml(opt_data.tagName ? opt_data.tagName : 'div'), '>');
  return opt_sb ? '' : output.toString();
};
